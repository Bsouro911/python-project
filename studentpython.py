...
def get_batch():
    with open(f'C:/python_project/Batch.csv','r') as f:
        reader=csv.reader(f)
...
def remove(string):
    with open(f'C:/python_project/Student.csv','r+',newline='') as f:
        script=csv.reader(f)
...
while message:
    ...
    with open(f'{path}/Department.csv','a',newline='')as f:
        ...
        script.writerow(['CSE(AI)','Computer Sience and Engineering and Artificial Intelligence'])
        script.writerow(['CSE(AIML)','Computer Sience and Engineering and Artificial Intelligence and Machine Learning'])
        script.writerow(['CSE(IOTCSBST)','Computer Sience and Engineering and Internet of Things, Cyber Security and Blockchain Technology'])
...
print('\n','Computer Sience and Engineering : CSE','\n',
      ...
      'Computer Sience and Engineering and Internet of Things, Cyber Security and Blockchain Technology : CSE(IOTCSBST)','\n',
...
for i in range(student_no):
    ...
    stream=input("Which Stream HE/SHE is in (e.g. CSE) : ")
    roll=input("What is HIS/HER Class Roll Number : ")
